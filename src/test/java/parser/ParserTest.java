...
public class ParserTest {
    ...
    public void testNot() {
        ...
        assertEquals(TermExpression.class, expression.getExpression().getClass());
    }
    ...
    public void testComplex() {
        ...
        assertEquals("1", ((TermExpression)e_1.getExpression()).getTerm());
        ...
        assertEquals("3", ((TermExpression)e_2_2.getExpression()).getTerm());
        ...
        assertEquals("5", ((TermExpression)e_3_1_2.getExpression()).getTerm());
